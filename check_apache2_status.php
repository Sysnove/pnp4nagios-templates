...
$opt[1] = "--vertical-label \"Apache2 Uptime\" --title \"Server $hostname\" $options $colors ";
$ds_name[1] = "Apache2 Uptime";

$def[1] = rrd::def("var1", $RRDFILE[1], $DS[1]);

$opt[1] = "--vertical-label \"Apache2 Requests\" --title \"Server $hostname\" $options $colors ";
$ds_name[1] = "Apache2 Requests";
...
$opt[3] = "--vertical-label \"Threads\"  --title \"Apache2 Workers\" $options $colors ";
$ds_name[3] = "Apache2 Workers";
